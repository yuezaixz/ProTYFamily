...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let environmentMap = UIImage(named: "game.scnassets/sharedImages/environment_blur.exr") {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(showGameScene))
